...
import 'package:gym_mirror/data/repositories/finished_workout_repository_impl.dart';
...
import 'package:gym_mirror/domain/usecases/finished_workout/create_finished_workout.dart';
import 'package:gym_mirror/domain/usecases/finished_workout/delete_finished_workout.dart';
import 'package:gym_mirror/domain/usecases/finished_workout/get_finished_workout_by_id.dart';
import 'package:gym_mirror/domain/usecases/finished_workout/get_finished_workouts.dart';
import 'package:gym_mirror/domain/usecases/finished_workout/update_workout.dart';
...
Future<void> init() async {
  ...
  //Finishe Workout Use Cases
  getIt.registerLazySingleton(() => CreateFinishedWorkout(getIt()));
  getIt.registerLazySingleton(() => DeleteFinishedWorkout(getIt()));
  getIt.registerLazySingleton(() => GetFinishedWorkoutById(getIt()));
  getIt.registerLazySingleton(() => GetFinishedWorkouts(getIt()));
  getIt.registerLazySingleton(() => UpdateFinishedWorkout(getIt()));
  ...
  getIt.registerLazySingleton<FinishedWorkoutRepository>(() => FinishedWorkoutRepositoryImpl(localDatasource: getIt()));
  ...
  getIt.registerLazySingleton<FinishedWorkoutLocalDatasource>(() => FinishedWorkoutLocalDatasource(finishedWorkoutBox: getIt()));
  ...
  getIt.registerLazySingleton<Box<FinishedWorkoutModel>>(() => Hive.box<FinishedWorkoutModel>('finishedWorkoutBox'));
  ...
  getIt.registerFactory(() => FinishedWorkoutBloc(getIt<FinishedWorkoutRepository>()));
}